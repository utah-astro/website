            ...
            <div class="uu-container">
                <div class="uu-main-top row" id="uu-skip-target">
                    <div class="uu-top-content">
                        <h1 class="page-title">Astro Group: Undergraduate Program</h1>
                    </div>
                </div>
                <div class="uu-main-bottom row">
                    <div class="uu-main-column">
                        <div class="uu-main-content">
                            <p><img class="img-float-left" src="../resources/jpg/bnr_undergrad.jpg"></p>
                            <p>
                            ...
                            <ul>
                                <li><a target="_physics" href="https://www.physics.utah.edu/reu-opportunities/">Research Experiences for Undergrads (REU)</a> Program:  The application deadline for this opportunity is January 31, 2022.</li>
                            </ul>
                        </div>
                    </div>
